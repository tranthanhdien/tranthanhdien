...
<body>
	...
	<div>
		<input type="text" placeholder="Nhập giá trị tìm kiếm..."
			style="margin-left: 30%; width: 39%; height: 33px;" autofocus>
		<button type="button" class="btn btn-primary">
			<span class="glyphicon glyphicon-search"></span>&nbsp;Tìm kiếm
		</button>
		<a href="addEmployee.jsp"><button type="button"
	...
	<div class="container" id=center>
		...
		<table class="table table-striped table-hover">
			...
			<tr>
				...
				<td><%=e.getDob()%>
				<td><%=e.getAddress()%>
				<td><a href="#"><button type="button" class="btn btn-info">
							<span class="glyphicon glyphicon-info-sign"></span>
						</button></a> <a href="addEmployee.jsp"><button type="button"
							class="btn btn-primary">
							<span class="glyphicon glyphicon-edit"></span>
						</button></a> <a href="ServletXoaEmp?id=<%=i%>"><button type="button"
