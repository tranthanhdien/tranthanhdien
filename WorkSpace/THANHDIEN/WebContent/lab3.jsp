		...
		<div class="container" style="width: 500px;">
			<div style="color: black;" class="dangnhap">
				<form action="ServletLab3" method="post">
					...
					<p style="color: red; text-align: center;"><%=request.getAttribute("mail") %>
					</p>
					...
					<p style="color: red; text-align: center;"><%=request.getAttribute("pass") %>
					</p>
					<div class="row">
					...
					<p style="color: red; text-align: center;"><%=request.getAttribute("re_pass") %>
					</p>
					

					<div class="canhan">
						<h2 id="dn" style="margin-left: 120px">THÔNG TIN CÁ NHÂN</h2>
						<div class="row">
							...
							<div class="col-sm-8">
								<input style="margin-bottom: 10px" type="text" name="hovaten"
									...
									placeholder="Nhập vào tên của bạn..." value="<%=request.getParameter("hoTen") %>">
							</div>
						</div>
						<p style="color: red; text-align: center;"><%=request.getAttribute("hoten") %>
						</p>
						...
						<p style="color: red; text-align: center;"><%=request.getAttribute("phone_1") %>
						</p>
						...
						<div class="row">
							...
							<div class="col-sm-8">
								<input type="number" name="sodidong" class="form-control"
									id="txtPhone2" placeholder="Nhập vào số di động..." value="<%=request.getParameter("sdđ") %>">
							</div>
						</div>
						
					</div>
					<p style="color: red; text-align: center;"><%=request.getAttribute("phone_2") %>
					</p>
					<div class="diachi">
						<h2 id="dn" style="margin-left: 200px">ĐỊA CHỈ</h2>
						<div class="row" style="margin-bottom: 10px">
						...
						<div class="row" style="margin-bottom: 10px">
							...
							<div class="col-sm-8">
								<textarea rows="5" cols="40" name="diachinha" value="<%=request.getParameter("address") %>"
									class="form-control"></textarea>
							</div>
						</div>
						<p style="color: red; text-align: center;"><%=request.getAttribute("address") %>
						</p>
					</div>
