			...
			<div class="modal-body">
				<form action="ControllerShopping?action=register" method="post" class="p-3">
					<div class="form-group">
						...
						<!-- invalidation -->
						<%
							if (request.getAttribute("name_error_register") != null) {
							out.print("<font color=\"red\">" + (String) request.getAttribute("name_error_register") + "</font");
							}
						%>
					</div>
					<div class="form-group">
