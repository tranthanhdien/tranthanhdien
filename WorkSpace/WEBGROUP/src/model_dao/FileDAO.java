		...
		if (listBig.size() < 5 || listBig.size() > 5) {
			...
			for (int j = 0; j < listBig.size(); j++) {
				...
				mapProduct.put(list.get(0),
						new Product(Integer.parseInt(list.get(0)), list.get(1), Double.parseDouble(list.get(2)), list.get(3), list.get(4)));
			}
		}
		return mapProduct;
	}
...
//	}
	...
	public static void main(String[] args) {
		...
		System.out.println(test.getProduct(test.getStringArray()));
	}
}
