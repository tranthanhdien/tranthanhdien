			...
			<div class="col_3">
				...
				<div style="width: 80%; float: right; margin-right: 15%;">
					<table>
						<tr>
							<td><b>Ngày HD: </b></td>
							<td>${sessionScope.invoiceInvoice.today }</td>
						</tr>
						<tr>
							<td><b>Giao hàng đến: </b></td>
							<td>&nbsp; ${sessionScope.userInvoice.username }</td>
						</tr>
						<tr>
							<td></td>
							<td>&nbsp; ${sessionScope.userInvoice.fullName }</td>
						</tr>
						<tr>
							<td></td>
							<td>&nbsp; ${sessionScope.userInvoice.phone }</td>
						</tr>
						<tr>
							<td></td>
							<td>&nbsp; ${sessionScope.userInvoice.address }</td>
						</tr>
					</table>
				</div>
				<div style="width: 95%; margin-right: 2%; float: right;">
					<div class="bs-example widget-shadow"
						...
						<table class="table table-hover">
							...
							<tbody>
								...
								<%
									ShoppingCart shop = (ShoppingCart) session.getAttribute("shopInvoice");
					...
					<div>
						<ul class="bt-list">
							<li><a
								href="<%=request.getContextPath()%>/ControllerAdmin?action=processInvoice"
								class="hvr-icon-fade col-7">Xử lí hóa đơn</a></li>
								<li><a href="#" class="hvr-icon-spin col-5">Từ chối hóa đơn</a></li>
							<li><a
								href="<%=request.getContextPath()%>/ControllerAdmin?action=displayInvoiceProcess"
								class="hvr-icon-forward col-2">Danh sách hóa đơn chưa xử lí</a></li>
