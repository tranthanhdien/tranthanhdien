				...
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1>
							<a class="navbar-brand"
								href="<%=request.getContextPath()%>/admin/index.jsp"><span
								class="fa fa-area-chart"></span> Lightting<span
								class="dashboard_text">Administrator</span></a>
						</h1>
					</div>
					<div class="collapse navbar-collapse"
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview"><a
								href="<%=request.getContextPath()%>/admin/index.jsp"> <i
									class="fa fa-dashboard"></i> <span>Dashboard</span>
							</a></li>

							<li class="treeview"><a href="<%=request.getContextPath()%>/index.jsp"> <i
									class="fa fa-pie-chart"></i> <span>Trang bán hàng</span> 
							</a></li>
							<li class="treeview"><a href="<%=request.getContextPath()%>/ControllerAdmin?action=displayInvoiceProcess"> <i
									class="fa fa-pie-chart"></i> <span>Xử lí hóa đơn</span> 
							</a></li>
							<li class="treeview"><a href="<%=request.getContextPath()%>/admin/product/quanlisanpham.jsp"> <i
									class="fa fa-pie-chart"></i> <span>Quản lí sản phẩm</span> 
							</a></li>
							<li class="treeview"><a href="<%=request.getContextPath()%>/ControllerAdmin?action=quanlikhachhang"> <i
									class="fa fa-pie-chart"></i> <span>Quản lí người dùng</span> 
							</a></li>
							<li class="treeview"><a href="<%=request.getContextPath()%>/admin/invoice/quanlihoadon.jsp"> <i
									class="fa fa-pie-chart"></i> <span>Quản lí hóa đơn</span> 
							</a></li>
							<li class="treeview"><a href="<%=request.getContextPath()%>/admin/report/reports.jsp""> <i
									class="fa fa-pie-chart"></i> <span>Biểu đồ thống kê</span> 
							</a></li>
