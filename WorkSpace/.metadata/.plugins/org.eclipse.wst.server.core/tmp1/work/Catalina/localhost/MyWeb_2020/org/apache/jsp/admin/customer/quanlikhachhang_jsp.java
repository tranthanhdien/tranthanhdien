 ...
 * Generated at: 2020-02-18 13:05:26 UTC
...
public final class quanlikhachhang_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<h2 style=\"text-align: center\">QUẢN LÍ KHÁCH HÀNG</h2>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\thref=\"");
      out.print(request.getContextPath());
      out.write("/ControllerAdmin?action=displayReport&name=userReport\"><button\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<th title=\"Mã khách hàng\">Mã KH</th>\r\n");
      ...
      out.write("</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(c.getL().getIdUser());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(c.getL().getEmail());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(c.getC().getUsername());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(c.getC().getFullName());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(c.getC().getPhone());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>");
      out.print(c.getC().getAddress());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<table>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\taction=\"");
      out.print(request.getContextPath());
      out.write("/ControllerUser?action=remove&id=");
      out.print(c.getL().getIdUser());
      out.write("\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\thref=\"");
      out.print(request.getContextPath());
      out.write("/ControllerUser?action=lookToEdit&id=");
      out.print(c.getC().getId());
      out.write("\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\thref=\"");
      out.print(request.getContextPath());
      out.write("/ControllerUser?action=lookUp&id=");
      out.print(c.getC().getId());
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"btn btn-primary\" style=\"font-size: 13px;\"><span\r\n");
      ...
      out.print(new CustomerDAO().dynamicIDCustomer() );
      out.write("\" name=\"id\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"input-group\" style=\"display: grid;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"ten\"><b>Tên đăng nhập</b></label> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\ttype=\"text\" placeholder=\"Nhập tên đăng nhập\" name=\"name\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\trequired>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Họ và tên\" name=\"fullname\" required>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Nhập mật khẩu\" name=\"pass\" required>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><div class=\"input-group \" style=\"display: grid;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"giam\"><b>Số điện thoại</b></label> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\ttype=\"text\" placeholder=\"Nhập số điện thoại\" name=\"phone\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tpattern=\"[0-9]{10}\" required>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><div class=\"input-group \" style=\"display: grid;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<label for=\"gia\"><b>Email</b></label> <input type=\"email\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Nhập Email\" name=\"email\" required>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div></td>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Nhập địa chỉ\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td colspan=\"3\"><b>Admin </b>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"admin\" value=\"yes\">Có\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"admin\" value=\"no\">Không\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t<th style=\"width: 10%\">Mã khách hàng</th>\r\n");
      out.write("\t\t\t\t\t<th style=\"width: 20%\">Tên đăng nhập</th>\r\n");
      out.write("\t\t\t\t\t<th style=\"width: 10%\">Họ và tên</th>\r\n");
      out.write("\t\t\t\t\t<th style=\"width: 10%\">Điện thoại</th>\r\n");
      out.write("\t\t\t\t\t<th style=\"width: 10%\">Địa chỉ</th>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t");
      ...
      out.write("\t\t\tnewWin.document.write(\"<h3 align='center'>DANH SÁCH KHÁCH HÀNG</h3>\");\r\n");
