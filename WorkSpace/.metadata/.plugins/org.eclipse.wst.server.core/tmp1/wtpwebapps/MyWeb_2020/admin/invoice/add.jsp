...
<body class="cbp-spmenu-push">
	...
	<div id="page-wrapper">
		<div class="main-page">
			<div class="col_3">
				<h2 style="text-align: center">Thêm hóa đơn</h2>
				<!-- the hien noi dung o day -->
				<div style="width: 80%; float: right; margin-right: 15%;">
					<table>
						<tr>
							<td><b>Ngày HD: </b></td>
							<td>&nbsp; <input type="text" id="tbDate" name="date"
								placeholder="Ngày hóa đơn" style="width: 300px;"></td>
						</tr>
						<tr>
						...
						<table class="table table-hover">
							...
							<tbody>
								<tr>
									...
									<td></td>
									<td></td>
									<td><img src="" class="img-responsive img-thumbnail"
										style="width: 15%"></td>
									<td></td>
									<!-- goi servlet xoa 1 moon hang -->
									<td><A href=""><span class="fa fa-times-circle-o"
											style="font-size: 24px;"></span></A></td>
								</tr>
