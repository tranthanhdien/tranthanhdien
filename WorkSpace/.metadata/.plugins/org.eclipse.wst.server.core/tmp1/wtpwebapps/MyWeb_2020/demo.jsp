			...
			<div class="container">
				<div class="input-group" style="display: grid; width: 610px;">
					<label for="ma"><b>Mã sản phẩm</b></label> <input type="text"
						placeholder="Nhập mã sản phẩm" name="ma" required>
				</div>
				<div class="input-group" style="display: grid; width: 610px;">
					<label for="ten"><b>Tên sản phẩm</b></label> <input type="text"
						placeholder="Nhập tên sản phẩm" name="ten" required>
				</div>
				<div class="input-group" style="display: grid; width: 610px;">
					<label for="mota"><b>Mô tả</b></label> <input type="text"
						placeholder="Mô tả sản phẩm" name="mota" required>
				</div>
				<div class="input-group " style="display: grid; width: 610px;">
					<label for="gia"><b>Giá bán</b></label> <input type="text"
						placeholder="Giá bán sản phẩm" name="gia" required>
				</div>
				<div class="input-group " style="display: grid; width: 610px;">
					<label for="giam"><b>Giảm giá</b></label> <input type="text"
						placeholder="Giảm giá" name="giam" required>
				</div>
				<div class="input-group" style="display: grid; width: 610px;">
					<label for="sl"><b>Số lượng trong kho</b></label> <input
						type="text" placeholder="Số lượng trong kho" name="sl" required>
				</div>
				<div>
					<button id="show" onclick="myFunction()"
						style="display: grid; border-radius: 10px; width: 100px;">
						<i class="fas fa-plus-square"></i>Mở rộng
					</button>
					<div id="id02" style="display: none;">
						<div class="input-group " style="display: grid; width: 610px;">
							<fieldset>
								<legend
									style="margin: 20px 0 0 0; font-weight: 700; font-size: 16px">
									Loại</legend>
								<label> <input type="radio" class="option-input radio"
									name="loai" checked /> Dân dụng
								</label> <label> <input type="radio" class="option-input radio"
									name="loai" /> Văn phòng
								</label> <label> <input type="radio" class="option-input radio"
									name="loai" /> Trang trí
								</label> </label> <label> <input type="radio" class="option-input radio"
									name="loai" /> Chuyên dụng
								</label>
							</fieldset>
						</div>
						<div class="input-group"
							style="display: grid; width: 610px; margin-bottom: 8px;">
							<fieldset>
								<legend
									style="margin: 20px 0 0 0; font-weight: 700; font-size: 16px">
									Nhóm</legend>
								<label> <input type="radio" class="option-input radio"
									name="nhom" checked /> Bóng led
								</label> <label> <input type="radio" class="option-input radio"
									name="nhom" /> Led âm trần
								</label> <label> <input type="radio" class="option-input radio"
									name="nhom" /> Led công nghiệp
								</label> </label> <label> <input type="radio" class="option-input radio"
									name="nhom" /> Led tuýp màu
								</label> </label> <label> <input type="radio" class="option-input radio"
									name="nhom" /> Đặc biệt
								</label>
							</fieldset>
						...
						<div class="input-group" style="width: 610px; margin-bottom: 8px;">
							<label for="congsuat"><b>Công suất</b></label> <input
								type="number" style="float: left;" id="quantity" maxlength="6"
								data-id="9578322" class="qty-input updateCart" name="congsuat"
								min="-5" max="200"> <label for="dienap"><b>Điện
									áp</b></label> <input type="text" name="dienap" value="220V/50Hz"
								readonly="readonly"
								style="padding: 2px 2.5px; margin: 0 .5rem 0 0; max-width: 75px; float: left">
							<label for="baohanh"><b>Thời gian bảo hành</b></label> <input
								type="number" style="float: left;" id="quantity" maxlength="1"
								data-id="9578322" class="qty-input updateCart" name="baohanh"
								min="0" max="8"> <span
								style="float: left; line-height: 25px;">năm</span>
						</div>
						<div class="input-group" style="width: 610px; margin-bottom: 8px;">
							...
							<div class="wrapper">
								...
								<div class="change-icon">
									<a href="#" data-toggle='modal' data-target='#image-editor'><span
										class="icon-container"><i class="far fa-image"
											style="font-size: 40px;"></i></span></a>
								</div>
								<!--    Editor Modal-->
								<div id="image-editor" class="modal fade editor-modal"
									role="dialog">
													...
													<div class="editor-container">
														<div class="editor">
															<div class="resize-container">
																<span class="resize-handle resize-handle-nw"></span> <span
																	class="resize-handle resize-handle-ne"></span> <img
																	class="resize-image" src="" alt=""> <span
																	class="resize-handle resize-handle-se"></span> <span
											...
											<div class="modal-footer">
												<div class="upload">
													<form action="#" method="POST" role="form">
														<input type="file" acccept="images/" class="form-control"
															id="uploaded-img" placeholder="Input field"
															accept="image/*">
														<div class="upload-button">
															<label for="uploaded-img"> <span
																class="label-text">Chọn ảnh</span><span
																class="upload-icon"><i class="fa fa-upload"></i></span>
															</label>
														</div>
														<div class="edit-button">
															<input type="submit" class="js-crop btn form-control"
																style="background: teal; font-weight: bold; font-size: initial;"
																data-dismiss="modal" value="Upload">
														</div>
													</form>
												</div>
											</div>
