						...
						<ul class="sidebar-menu">
							...
							<li class="treeview"><a
								href="<%=request.getContextPath()%>/ControllerAdmin?action=displayInvoiceProcess">
									<i class="fa fa-pie-chart"></i> <span>Xử lí hóa đơn</span>
							</a></li>
							<li class="treeview"><a
								href="<%=request.getContextPath()%>/ControllerProduct?action=truyXuatSanPham">
									<i class="fa fa-pie-chart"></i> <span>Quản lí sản phẩm</span>
							</a></li>
							<li class="treeview"><a
								href="<%=request.getContextPath()%>/ControllerUser?action=quanlikhachhang">
									<i class="fa fa-pie-chart"></i> <span>Quản lí người dùng</span>
							</a></li>
							<li class="treeview"><a
								href="<%=request.getContextPath()%>/ControllerInvoice?action=quanlihoadon">
									<i class="fa fa-pie-chart"></i> <span>Quản lí hóa đơn</span>
							</a></li>
							<li class="treeview"><a
								href="<%=request.getContextPath()%>/admin/report/reports.jsp"">
									<i class="fa fa-pie-chart"></i> <span>Biểu đồ thống kê</span>
							</a></li>
							<li class="treeview"><a
								href="<%=request.getContextPath()%>/admin/report/report.jsp"">
									<i class="fa fa-pie-chart"></i> <span>Thong ke main</span>
							</a></li>
					...
					<ul>
						<li class="dropdown profile_details_drop"><a href="#"
							...
							<ul class="dropdown-menu drp-mnu">
								...
								<li><a href="#"><i class="fa fa-user"></i> Tài khoản
										của tôi</a></li>
