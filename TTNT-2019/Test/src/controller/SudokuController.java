...
public class SudokuController implements MouseListener {
	...
	/**
	 * Recovers if user clicked field in game. If so it sets the selected number at
	 * clicked position in game and updates clicked field. If user clicked a field
	 * and used left mouse button, number at clicked position will be cleared in
	 * game and clicked field will be updated.
	 *
	 * @param e MouseEvent.
	 */
